...
const routes = [
  ...
  { path: '/vehicles/maintenance', name: 'vehicles-maintenance', component: VehiclesMaintenance, meta: { requiresAuth: true, title: 'Vehicle Maintenance', moduleKey: 'vehicles', action: 'read' } },
  { path: '/vehicles/overview', name: 'vehicles-overview', component: VehiclesOverview, meta: { requiresAuth: true, title: 'Vehicle Overview', moduleKey: 'vehicles', action: 'read' } },
  // Add Vehicle route
  ...
  { path: '/vehicles/:deviceId', name: 'vehicles-detail', component: VehicleDetail, meta: { requiresAuth: true, title: 'Vehicle Detail', moduleKey: 'vehicles', action: 'read' } },
  // Edit Vehicle route
