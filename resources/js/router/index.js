...
const ReportsFuelEfficiency = () => import('../views/reports/FuelEfficiency.vue');
...
const routes = [
  ...
  { path: '/dashboard', name: 'dashboard', component: Dashboard, meta: { requiresAuth: true, title: 'Overview', roles: [2, 3] } },
  ...
  { path: '/system-logs', name: 'system-logs', component: () => import('../views/system-logs/Index.vue'), meta: { requiresAuth: true, title: 'Logs', roles: [1] } },
  { path: '/profile', name: 'profile', component: Profile, meta: { requiresAuth: true, title: 'Profile' } },
  // Feature screens
  { path: '/monitoring/vehicles', name: 'monitoring-vehicles', component: MonitoringVehicles, meta: { requiresAuth: true, title: 'Vehicles', moduleKey: 'monitoring.vehicles', action: 'read' } },
  { path: '/monitoring/dashboard', name: 'monitoring-dashboard', component: MonitoringDashboard, meta: { requiresAuth: true, title: 'Dashboard', moduleKey: 'monitoring.vehicles', action: 'read' } },
  { path: '/monitoring/zones', name: 'monitoring-zones', component: MonitoringZones, meta: { requiresAuth: true, title: 'Zones', moduleKey: 'monitoring.zones', action: 'read' } },
  { path: '/monitoring/zones/:zoneId(\\d+)', name: 'monitoring-zone-details', component: () => import('../views/monitoring/ZoneDetails.vue'), meta: { requiresAuth: true, title: 'Zone Details', moduleKey: 'monitoring.zones', action: 'read' } },
  { path: '/live-tracking', name: 'live-tracking', component: LiveTracking, meta: { requiresAuth: true, title: 'Realtime Tracking', roles: [0, 1] } },
  { path: '/drivers', name: 'drivers', component: Drivers, meta: { requiresAuth: true, title: 'All Drivers', moduleKey: 'drivers', action: 'read' } },
  { path: '/drivers/assignments', name: 'drivers-assignments', component: () => import('../views/drivers/Assignments.vue'), meta: { requiresAuth: true, title: 'Assignments', moduleKey: 'drivers', action: 'read' } },
  ...
  // Users routes
  { path: '/users', name: 'users', component: Users, meta: { requiresAuth: true, title: 'User List', moduleKey: 'users', action: 'read' } },
  { path: '/users/permissions', name: 'users-permissions', component: UsersPermissions, meta: { requiresAuth: true, title: 'Permissions', roles: [1, 2, 3], moduleKey: 'users.permissions', action: 'update' } },
  ...
  { path: '/vehicles', name: 'vehicles', component: Vehicles, meta: { requiresAuth: true, title: 'Vehicle List', moduleKey: 'vehicles', action: 'read' } },
  { path: '/vehicles/maintenance', name: 'vehicles-maintenance', component: VehiclesMaintenance, meta: { requiresAuth: true, title: 'Maintenance', moduleKey: 'vehicles.maintenance', action: 'read' } },
  { path: '/vehicles/alerts', name: 'vehicles-alerts', component: VehiclesAlert, meta: { requiresAuth: true, title: 'Alerts', moduleKey: 'vehicles.maintenance', action: 'read' } },
  { path: '/vehicles/overview', name: 'vehicles-overview', component: VehiclesOverview, meta: { requiresAuth: true, title: 'Details', moduleKey: 'vehicles.overview', action: 'read' } },
  // Add Vehicle route
  ...
  { path: '/reports', name: 'reports', component: Reports, meta: { requiresAuth: true, title: 'Reports', moduleKey: 'reports', action: 'read' } },
  { path: '/reports/trip-analysis', name: 'reports-trip-analysis', component: ReportsTripAnalysis, meta: { requiresAuth: true, title: 'Trips', moduleKey: 'reports', action: 'read' } },
  { path: '/reports/asset-activity', name: 'reports-asset-activity', component: ReportsAssetActivity, meta: { requiresAuth: true, title: 'Asset Activity', moduleKey: 'reports', action: 'read' } },
  { path: '/reports/vehicle-activity', name: 'reports-vehicle-activity', component: ReportsVehicleActivity, meta: { requiresAuth: true, title: 'Vehicle Activity', moduleKey: 'reports', action: 'read' } },
  { path: '/reports/vehicle-status', name: 'reports-vehicle-status', component: ReportsVehicleStatus, meta: { requiresAuth: true, title: 'Vehicle Status', moduleKey: 'reports', action: 'read' } },
  { path: '/reports/idling', name: 'reports-idling', component: ReportsIdling, meta: { requiresAuth: true, title: 'Idling', moduleKey: 'reports', action: 'read' } },
  { path: '/reports/utilisation', name: 'reports-utilisation', component: ReportsUtilisation, meta: { requiresAuth: true, title: 'Utilisation', moduleKey: 'reports', action: 'read' } },
  { path: '/reports/incident-analysis', name: 'reports-incident-analysis', component: ReportsIncidentAnalysis, meta: { requiresAuth: true, title: 'Incidents', moduleKey: 'reports', action: 'read' } },
  ...
  { path: '/zones', name: 'zones', component: Zones, meta: { requiresAuth: true, title: 'Zones', moduleKey: 'zones', action: 'read' } },
